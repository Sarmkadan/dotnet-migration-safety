...
namespace MigrationSafety.Analyzers
{
    ...
    internal static class Descriptors
    {
        ...
        internal static readonly DiagnosticDescriptor UnreviewedSuppression = new DiagnosticDescriptor(
            id: DiagnosticIds.UnreviewedSuppression,
            title: "Unreviewed migration-safety suppression comment",
            messageFormat: "Suppression comment '// migration-safety:reviewed' found but not in baseline file '{0}'. Add it to migration-safety-baseline.json or remove the suppression.",
            category: DiagnosticIds.Category,
            defaultSeverity: DiagnosticSeverity.Error,
            isEnabledByDefault: true,
            description: "Migration-safety suppression comments must be tracked in a baseline file (migration-safety-baseline.json) to ensure all suppressions are reviewed and auditable. This prevents self-service data loss through undocumented suppressions.",
            helpLinkUri: HelpUriBase + "MIG999.md");
    }
}